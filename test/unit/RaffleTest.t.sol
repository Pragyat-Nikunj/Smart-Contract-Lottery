...
contract RaffleTest is CodeConstants, Test {
    ...
    function testFulfillrandomwordsCanOnlyBeCalledAfterPerformUpkeep(uint256 randomRequetId) public skipFork {
        ...
        VRFCoordinatorV2_5Mock(vrfCoordinator).fulfillRandomWords(randomRequetId, address(raffle));
    }

    function testFulfillrandomwordsPicksWinnerResetsAndFundsMoney() public raffleEntered skipFork {
        // Arrange
        uint256 additionalEntrants = 3; //total
